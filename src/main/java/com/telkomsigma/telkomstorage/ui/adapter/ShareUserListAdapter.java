...
public class ShareUserListAdapter extends ArrayAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (mShares != null && mShares.size() > position) {
            ...
            TextView userName = (TextView) view.findViewById(com.telkomsigma.telkomstorage.R.id.userOrGroupName);
            ImageView iconView = (ImageView) view.findViewById(com.telkomsigma.telkomstorage.R.id.icon);
            final ImageView editShareButton = (ImageView) view.findViewById(com.telkomsigma.telkomstorage.R.id.editShareButton);
            final ImageView unshareButton = (ImageView) view.findViewById(com.telkomsigma.telkomstorage.R.id.unshareButton);
