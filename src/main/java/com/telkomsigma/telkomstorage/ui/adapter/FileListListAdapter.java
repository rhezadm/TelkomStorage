...
public class FileListListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (file != null) {
            ImageView fileIcon = (ImageView) view.findViewById(com.telkomsigma.telkomstorage.R.id.thumbnail);
            ...
            switch (viewType) {
                case LIST_ITEM:
                    TextView fileSizeV = (TextView) view.findViewById(com.telkomsigma.telkomstorage.R.id.file_size);
                    TextView fileSizeSeparatorV = (TextView) view.findViewById(com.telkomsigma.telkomstorage.R.id.file_separator);
                    TextView lastModV = (TextView) view.findViewById(com.telkomsigma.telkomstorage.R.id.last_mod);
                ...
                case GRID_ITEM:
                    // filename
                    fileName = (TextView) view.findViewById(com.telkomsigma.telkomstorage.R.id.Filename);
                ...
                case GRID_IMAGE:
                    ...
                    // local state
                    ImageView localStateView = (ImageView) view.findViewById(com.telkomsigma.telkomstorage.R.id.localFileIndicator);
            ...
            ImageView checkBoxV = (ImageView) view.findViewById(com.telkomsigma.telkomstorage.R.id.custom_checkbox);
            ...
            if (parentList.getChoiceMode() != AbsListView.CHOICE_MODE_NONE && parentList.getCheckedItemCount() > 0) {
                ...
                if (mHideItemOptions) {
                    ImageView sharedIconView = (ImageView) view.findViewById(com.telkomsigma.telkomstorage.R.id.sharedIcon);
                    sharedIconView.setVisibility(View.GONE);

                    ImageView overflowIndicatorView = (ImageView) view.findViewById(com.telkomsigma.telkomstorage.R.id.overflow_menu);
    ...
    private void showShareIcon(View view, OCFile file) {
        ImageView sharedIconV = (ImageView) view.findViewById(com.telkomsigma.telkomstorage.R.id.sharedIcon);
    ...
    private void showOverflowMenuIcon(View view, OCFile file, ViewType viewType) {
        if (ViewType.LIST_ITEM.equals(viewType)) {
            ImageView overflowIndicatorV = (ImageView) view.findViewById(com.telkomsigma.telkomstorage.R.id.overflow_menu);
