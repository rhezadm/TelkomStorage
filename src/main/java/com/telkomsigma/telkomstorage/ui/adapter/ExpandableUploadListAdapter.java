...
public class ExpandableUploadListAdapter extends BaseExpandableListAdapter implements Observer {
    ...
    private View getView(OCUpload[] uploadsItems, int position, View convertView, ViewGroup parent) {
        ...
        if (uploadsItems != null && uploadsItems.length > position && uploadsItems[position] != null) {
            ...
            // local file name
            TextView fileTextView = (TextView) view.findViewById(com.telkomsigma.telkomstorage.R.id.upload_name);
            ...
            TextView pathTextView = (TextView) view.findViewById(com.telkomsigma.telkomstorage.R.id.upload_remote_path);
            String remoteParentPath = new File(upload.getRemotePath()).getParent();
            pathTextView.setText(remoteParentPath);

            // file size
            TextView fileSizeTextView = (TextView) view.findViewById(com.telkomsigma.telkomstorage.R.id.upload_file_size);
            ...
            //* upload date
            TextView uploadDateTextView = (TextView) view.findViewById(com.telkomsigma.telkomstorage.R.id.upload_date);
            ...
            TextView accountNameTextView = (TextView) view.findViewById(com.telkomsigma.telkomstorage.R.id.upload_account);
            ...
            TextView statusTextView = (TextView) view.findViewById(com.telkomsigma.telkomstorage.R.id.upload_status);

            ProgressBar progressBar = (ProgressBar) view.findViewById(com.telkomsigma.telkomstorage.R.id.upload_progress_bar);
            ...
            /// bind listeners to perform actions
            ImageButton rightButton = (ImageButton) view.findViewById(com.telkomsigma.telkomstorage.R.id.upload_right_button);
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        TextView tv = (TextView) convertView.findViewById(com.telkomsigma.telkomstorage.R.id.uploadListGroupName);
