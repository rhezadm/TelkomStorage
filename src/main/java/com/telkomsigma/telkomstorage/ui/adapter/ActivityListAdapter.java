...
public class ActivityListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private class ActivityViewHolder extends RecyclerView.ViewHolder {
        ...
        private ActivityViewHolder(View itemView) {
            super(itemView);
            activityIcon = (ImageView) itemView.findViewById(com.telkomsigma.telkomstorage.R.id.activity_icon);
            subject = (TextView) itemView.findViewById(com.telkomsigma.telkomstorage.R.id.activity_subject);
            message = (TextView) itemView.findViewById(com.telkomsigma.telkomstorage.R.id.activity_message);
            dateTime = (TextView) itemView.findViewById(com.telkomsigma.telkomstorage.R.id.activity_datetime);
            list = (GridLayout) itemView.findViewById(com.telkomsigma.telkomstorage.R.id.list);
        }
    }
    ...
    private class ActivityViewHeaderHolder extends RecyclerView.ViewHolder {
        ...
        private ActivityViewHeaderHolder(View itemView) {
            super(itemView);
            title = (TextView) itemView.findViewById(com.telkomsigma.telkomstorage.R.id.title_header);
