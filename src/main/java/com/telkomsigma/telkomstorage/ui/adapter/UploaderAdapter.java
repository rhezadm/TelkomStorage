...
public class UploaderAdapter extends SimpleAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView filename = (TextView) vi.findViewById(com.telkomsigma.telkomstorage.R.id.filename);
        filename.setText(file.getFileName());
        
        ImageView fileIcon = (ImageView) vi.findViewById(com.telkomsigma.telkomstorage.R.id.thumbnail);
        fileIcon.setTag(file.getFileId());

        TextView lastModV = (TextView) vi.findViewById(com.telkomsigma.telkomstorage.R.id.last_mod);
        lastModV.setText(DisplayUtils.getRelativeTimestamp(mContext, file.getModificationTimestamp()));

        TextView fileSizeV = (TextView) vi.findViewById(com.telkomsigma.telkomstorage.R.id.file_size);
        TextView fileSizeSeparatorV = (TextView) vi.findViewById(com.telkomsigma.telkomstorage.R.id.file_separator);
