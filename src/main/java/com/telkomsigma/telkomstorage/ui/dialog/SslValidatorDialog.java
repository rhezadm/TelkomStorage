...
public class SslValidatorDialog extends Dialog {
    ...
    public void updateResult(RemoteOperationResult result) {
        if (result.isSslRecoverableException()) {
            ...
            if (mException.getCertPathValidatorException() != null) {
                ((TextView)mView.findViewById(com.telkomsigma.telkomstorage.R.id.reason_cert_not_trusted)).setVisibility(View.VISIBLE);
            }
            
            if (mException.getCertificateExpiredException() != null) {
                ((TextView)mView.findViewById(com.telkomsigma.telkomstorage.R.id.reason_cert_expired)).setVisibility(View.VISIBLE);
            }
            
            if (mException.getCertificateNotYetValidException() != null) {
                ((TextView)mView.findViewById(com.telkomsigma.telkomstorage.R.id.reason_cert_not_yet_valid)).setVisibility(View.VISIBLE);
            } 

            if (mException.getSslPeerUnverifiedException() != null ) {
                ((TextView)mView.findViewById(com.telkomsigma.telkomstorage.R.id.reason_hostname_not_verified)).setVisibility(View.VISIBLE);
            }
    ...
    private void showSignature(X509Certificate cert) {
        TextView sigView = ((TextView)mView.findViewById(com.telkomsigma.telkomstorage.R.id.value_signature));
        TextView algorithmView = ((TextView)mView.findViewById(com.telkomsigma.telkomstorage.R.id.value_signature_algorithm));
    ...
    private void showValidity(Date notBefore, Date notAfter) {
        TextView fromView = ((TextView)mView.findViewById(com.telkomsigma.telkomstorage.R.id.value_validity_from));
        TextView toView = ((TextView)mView.findViewById(com.telkomsigma.telkomstorage.R.id.value_validity_to));
    ...
    private void showSubject(X500Principal subject) {
        ...
        TextView cnView = ((TextView)mView.findViewById(com.telkomsigma.telkomstorage.R.id.value_subject_CN));
        TextView oView = ((TextView)mView.findViewById(com.telkomsigma.telkomstorage.R.id.value_subject_O));
        TextView ouView = ((TextView)mView.findViewById(com.telkomsigma.telkomstorage.R.id.value_subject_OU));
        TextView cView = ((TextView)mView.findViewById(com.telkomsigma.telkomstorage.R.id.value_subject_C));
        TextView stView = ((TextView)mView.findViewById(com.telkomsigma.telkomstorage.R.id.value_subject_ST));
        TextView lView = ((TextView)mView.findViewById(com.telkomsigma.telkomstorage.R.id.value_subject_L));
    ...
    private void showIssuer(X500Principal issuer) {
        ...
        TextView cnView = ((TextView)mView.findViewById(com.telkomsigma.telkomstorage.R.id.value_issuer_CN));
        TextView oView = ((TextView)mView.findViewById(com.telkomsigma.telkomstorage.R.id.value_issuer_O));
        TextView ouView = ((TextView)mView.findViewById(com.telkomsigma.telkomstorage.R.id.value_issuer_OU));
        TextView cView = ((TextView)mView.findViewById(com.telkomsigma.telkomstorage.R.id.value_issuer_C));
        TextView stView = ((TextView)mView.findViewById(com.telkomsigma.telkomstorage.R.id.value_issuer_ST));
        TextView lView = ((TextView)mView.findViewById(com.telkomsigma.telkomstorage.R.id.value_issuer_L));
