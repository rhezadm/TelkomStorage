...
public class SortingOrderDialogFragment extends DialogFragment {
    ...
    private void setupDialogElements(View view) {
        ...
        mSortByNameAscendingButton = (ImageButton) view.findViewById(com.telkomsigma.telkomstorage.R.id.sortByNameAscending);
        mSortByNameDescendingButton = (ImageButton) view.findViewById(com.telkomsigma.telkomstorage.R.id.sortByNameDescending);
        mSortByModificationDateAscendingButton = (ImageButton) view.findViewById(com.telkomsigma.telkomstorage.R.id.sortByModificationDateAscending);
        mSortByModificationDateDescendingButton = (ImageButton) view.findViewById(com.telkomsigma.telkomstorage.R.id.sortByModificationDateDescending);
        mSortBySizeAscendingButton = (ImageButton) view.findViewById(com.telkomsigma.telkomstorage.R.id.sortBySizeAscending);
        mSortBySizeDescendingButton = (ImageButton) view.findViewById(com.telkomsigma.telkomstorage.R.id.sortBySizeDescending);
        mCancel = (AppCompatButton) view.findViewById(com.telkomsigma.telkomstorage.R.id.cancel);
        mCancel.setTextColor(ThemeUtils.primaryAccentColor());

        mSortByNameAscendingText = (TextView) view.findViewById(com.telkomsigma.telkomstorage.R.id.sortByNameAZText);
        mSortByNameDescendingText = (TextView) view.findViewById(com.telkomsigma.telkomstorage.R.id.sortByNameZAText);
        mSortByModificationDateAscendingText = (TextView) view.findViewById(com.telkomsigma.telkomstorage.R.id.sortByModificationDateOldestFirstText);
        mSortByModificationDateDescendingText = (TextView) view.findViewById(com.telkomsigma.telkomstorage.R.id.sortByModificationDateNewestFirstText);
        mSortBySizeAscendingText = (TextView) view.findViewById(com.telkomsigma.telkomstorage.R.id.sortBySizeSmallestFirstText);
        mSortBySizeDescendingText = (TextView) view.findViewById(com.telkomsigma.telkomstorage.R.id.sortBySizeBiggestFirstText);
