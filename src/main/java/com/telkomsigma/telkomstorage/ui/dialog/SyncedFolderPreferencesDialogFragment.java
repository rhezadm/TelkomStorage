...
public class SyncedFolderPreferencesDialogFragment extends DialogFragment {
    ...
    private void setupDialogElements(View view) {
        ...
        mEnabledSwitch = (SwitchCompat) view.findViewById(com.telkomsigma.telkomstorage.R.id.sync_enabled);
        ThemeUtils.tintSwitch(mEnabledSwitch, accentColor);

        mLocalFolderPath = (TextView) view.findViewById(com.telkomsigma.telkomstorage.R.id.synced_folders_settings_local_folder_path);

        mLocalFolderSummary = (TextView) view.findViewById(com.telkomsigma.telkomstorage.R.id.local_folder_summary);
        mRemoteFolderSummary = (TextView) view.findViewById(com.telkomsigma.telkomstorage.R.id.remote_folder_summary);

        mUploadOnWifiCheckbox = (AppCompatCheckBox) view.findViewById(com.telkomsigma.telkomstorage.R.id.setting_instant_upload_on_wifi_checkbox);
        ...
        mUploadBehaviorSummary = (TextView) view.findViewById(com.telkomsigma.telkomstorage.R.id.setting_instant_behaviour_summary);

        mCancel = (AppCompatButton) view.findViewById(com.telkomsigma.telkomstorage.R.id.cancel);
        mCancel.setTextColor(accentColor);

        mSave = (AppCompatButton) view.findViewById(com.telkomsigma.telkomstorage.R.id.save);
