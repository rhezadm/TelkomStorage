...
public class ErrorsWhileCopyingHandlerActivity  extends AppCompatActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView textView = (TextView) findViewById(com.telkomsigma.telkomstorage.R.id.message);
        ...
        ListView listView = (ListView) findViewById(com.telkomsigma.telkomstorage.R.id.list);
        ...
        /// customize buttons
        Button cancelBtn = (Button) findViewById(com.telkomsigma.telkomstorage.R.id.cancel);
        Button okBtn = (Button) findViewById(com.telkomsigma.telkomstorage.R.id.ok);
