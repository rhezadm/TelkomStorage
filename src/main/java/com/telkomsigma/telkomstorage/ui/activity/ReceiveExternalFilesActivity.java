...
public class ReceiveExternalFilesActivity extends FileActivity
    ...
    public static class DialogInputUploadFilename extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            final EditText userInput = (EditText) view.findViewById(com.telkomsigma.telkomstorage.R.id.user_input);
            setFilename(userInput, selectPos);
            userInput.requestFocus();

            final Spinner spinner = (Spinner) view.findViewById(com.telkomsigma.telkomstorage.R.id.file_type);
            setupSpinner(adapter, selectPos, userInput, spinner);
            if (adapter.getCount() == 1) {
                TextView label = (TextView) view.findViewById(com.telkomsigma.telkomstorage.R.id.label_file_type);
    ...
    private void populateDirectoryList() {
        ...
        if (mFile != null) {
            ...
            if (files.size() == 0) {
                ...
                Button btnChooseFolder = (Button) findViewById(com.telkomsigma.telkomstorage.R.id.uploader_choose_folder);
            ...
            if (getSupportActionBar() != null) {
                ...
                Button btnNewFolder = (Button) findViewById(com.telkomsigma.telkomstorage.R.id.uploader_cancel);
    ...
    protected void setupEmptyList() {
        mEmptyListContainer = (LinearLayout) findViewById(com.telkomsigma.telkomstorage.R.id.empty_list_view);
        mEmptyListMessage = (TextView) findViewById(com.telkomsigma.telkomstorage.R.id.empty_list_view_text);
        mEmptyListHeadline = (TextView) findViewById(com.telkomsigma.telkomstorage.R.id.empty_list_view_headline);
        mEmptyListIcon = (ImageView) findViewById(com.telkomsigma.telkomstorage.R.id.empty_list_icon);
        mEmptyListProgress = (ProgressBar) findViewById(com.telkomsigma.telkomstorage.R.id.empty_list_progress);
