...
public abstract class DrawerActivity extends ToolbarActivity implements DisplayUtils.AvatarGenerationListener {
    ...
    protected void setupDrawer() {
        mDrawerLayout = (DrawerLayout) findViewById(com.telkomsigma.telkomstorage.R.id.drawer_layout);

        mNavigationView = (NavigationView) findViewById(com.telkomsigma.telkomstorage.R.id.nav_view);
    ...
    private View findNavigationViewChildById(int id) {
        NavigationView view = ((NavigationView) findViewById(com.telkomsigma.telkomstorage.R.id.nav_view));
