...
public class FingerprintActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = (Toolbar) findViewById(com.telkomsigma.telkomstorage.R.id.toolbar);
        toolbar.setTitleTextColor(ThemeUtils.fontColor());
        toolbar.setBackground(new ColorDrawable(ThemeUtils.primaryColor()));
    }

    private void startFingerprint() {
        TextView fingerprintTextView = (TextView) findViewById(com.telkomsigma.telkomstorage.R.id.scanfingerprinttext);
            ...
            if (cipherInit()) {
                ...
                FingerprintHandler.Callback callback = new FingerprintHandler.Callback() {
                    ...
                    public void onFailed(String error) {
                        ...
                        ImageView imageView = (ImageView) findViewById(com.telkomsigma.telkomstorage.R.id.fingerprinticon);
                        int[][] states = new int[][]{
