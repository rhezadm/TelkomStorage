...
public class SyncedFoldersActivity extends FileActivity implements SyncedFolderAdapter.ClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CollapsingToolbarLayout mCollapsingToolbarLayout = ((CollapsingToolbarLayout)
                findViewById(com.telkomsigma.telkomstorage.R.id.collapsing_toolbar));
        mCollapsingToolbarLayout.setTitle(this.getString(com.telkomsigma.telkomstorage.R.string.drawer_synced_folders));

        mCustomFolderRelativeLayout = (RelativeLayout) findViewById(com.telkomsigma.telkomstorage.R.id.custom_folder_toolbar);
    ...
    private void setupContent() {
        ...
        BottomNavigationView bottomNavigationView = (BottomNavigationView) findViewById(com.telkomsigma.telkomstorage.R.id.bottom_navigation_view);
