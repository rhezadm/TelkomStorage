...
public class ExpandableListFragment extends ExtendedListFragment implements OnChildClickListener
 {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mList = (ExpandableListView)(v.findViewById(com.telkomsigma.telkomstorage.R.id.list_root));
...
//        }
        ...
        // Pull down refresh
        mRefreshListLayout = (SwipeRefreshLayout) v.findViewById(com.telkomsigma.telkomstorage.R.id.swipe_refresh_files);
        mRefreshEmptyLayout = (SwipeRefreshLayout) v.findViewById(com.telkomsigma.telkomstorage.R.id.swipe_refresh_files_emptyView);
