...
public class ContactListFragment extends FileFragment {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView) view.findViewById(com.telkomsigma.telkomstorage.R.id.contactlist_recyclerview);
    ...
    static class ContactItemViewHolder extends RecyclerView.ViewHolder {
        ...
        ContactItemViewHolder(View itemView) {
            ...
            badge = (ImageView) itemView.findViewById(com.telkomsigma.telkomstorage.R.id.contactlist_item_icon);
            name = (CheckedTextView) itemView.findViewById(com.telkomsigma.telkomstorage.R.id.contactlist_item_name);
