...
public class FileDownloadFragment extends FileFragment implements OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ProgressBar progressBar = (ProgressBar)mView.findViewById(com.telkomsigma.telkomstorage.R.id.progressBar);
    ...
    private void setButtonsForTransferring() {
        ...
        TextView progressText = (TextView) getView().findViewById(com.telkomsigma.telkomstorage.R.id.progressText);
