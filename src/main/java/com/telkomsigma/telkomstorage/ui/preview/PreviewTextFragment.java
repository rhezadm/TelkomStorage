...
public class PreviewTextFragment extends FileFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mTextPreview = (TextView) ret.findViewById(com.telkomsigma.telkomstorage.R.id.text_preview);

        mMultiView = (RelativeLayout) ret.findViewById(com.telkomsigma.telkomstorage.R.id.multi_view);
