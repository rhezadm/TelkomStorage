...
public class MediaControlView extends FrameLayout /* implements OnLayoutChangeListener, OnTouchListener */ implements OnClickListener, OnSeekBarChangeListener {
    ...
    */
    ...
    private void initControllerView(View v) {
        mPauseButton = (ImageButton) v.findViewById(com.telkomsigma.telkomstorage.R.id.playBtn);
        if (mPauseButton != null) {
            mPauseButton.requestFocus();
            mPauseButton.setOnClickListener(this);
        }

        mFfwdButton = (ImageButton) v.findViewById(com.telkomsigma.telkomstorage.R.id.forwardBtn);
        if (mFfwdButton != null) {
            mFfwdButton.setOnClickListener(this);
        }

        mRewButton = (ImageButton) v.findViewById(com.telkomsigma.telkomstorage.R.id.rewindBtn);
        if (mRewButton != null) {
            mRewButton.setOnClickListener(this);
        }

        mProgress = (ProgressBar) v.findViewById(com.telkomsigma.telkomstorage.R.id.progressBar);
        if (mProgress != null) {
        ...
        mEndTime = (TextView) v.findViewById(com.telkomsigma.telkomstorage.R.id.totalTimeText);
        mCurrentTime = (TextView) v.findViewById(com.telkomsigma.telkomstorage.R.id.currentTimeText);
    }
